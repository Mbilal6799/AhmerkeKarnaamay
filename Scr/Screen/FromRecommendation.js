...
const FromRecommendation = ({navigation}) => {
...
<View style={styles.arrowback}>
  ...
  <Text style={{fontSize:20,alignSelf:"center",fontWeight:"bold",color:COLOUR.white}}>Recommendation</Text>
    </View>
  
  </View>
  </View>
  <View style={{justifyContent:"center",marginTop:wp("10"),alignItems:"center",}}>
 <Text style={{fontWeight:"bold",padding:10,marginRight:wp("50")}}>Recommendation</Text>
  
<Comp reuse={"Email"} Place={"Abc@gmail.com"} home={'alternate-email'}/>

<Text style={{ width:wp("60"),marginTop:wp('2')}}>Recommend More Improve</Text>
...
export default FromRecommendation
